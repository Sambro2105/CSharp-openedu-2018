...
//    Минимум функции
//    Эта задача потребует знания конструкции if-else. Если вы с ней знакомы из других языков
//     программирования, это не составит проблем. Если не знакомы совсем, то лучше пропустить эту задачу
//     и сначала пройти следующий модуль.
//
...
namespace MinimumOfTheFunction
{
    class Program
    {
